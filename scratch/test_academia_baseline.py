...
def clean_query_text(text):
    ...
    text = re.sub(r'<[^>]+>', '', text)
    # Remove punctuation
    text = text.translate(str.maketrans('', '', string_punct)) if 'string_punct' in globals() else text
...
print(f"Average MRR@10 on academia with PRETRAINED Baseline: {mrr_total / count}")
