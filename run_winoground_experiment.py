...
def main():
    ...
    parser.add_argument("--clip-output", type=str, default="winoground_clip_results.json", help="Path to save CLIP results JSON")
    parser.add_argument("--vlm-output", type=str, default="winoground_vlm_results.json", help="Path to save VLM results JSON")
    parser.add_argument("--output", type=str, default="winoground_comparison_results.md", help="Path to save comparison markdown table")
    ...
    clip_cmd = [
        sys.executable, "winoground_lqe_eval.py",
    ...
    vlm_cmd = [
        sys.executable, "winoground_vlm_eval.py",
    ...
    compare_cmd = [
        sys.executable, "winoground_compare.py",
