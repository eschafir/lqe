...
\midrule
Vanilla Grep & \textbf{70.0\%} & 717.1 & 50.42\% & 1,949.6 \\
\textbf{LQE-Grep (v1)} & 60.0\% & 3,933.1 & 56.30\% & 5,689.8 \\
\textbf{LQE-Grep v2 (Ours)} & \textbf{60.0\%} & \textbf{2,897.7} & \textbf{57.98\%} & \textbf{3,182.3} \\
Vector Search & 0.0\% & \textbf{53.2} & 15.13\% & N/A \\
\bottomrule
\end{tabular}
\end{table}
