...
def main():
    ...
    clip_script = os.path.join(script_dir, "multimodal_lqe_eval.py")
    vlm_script = os.path.join(script_dir, "multimodal_vlm_eval.py")
    compare_script = os.path.join(script_dir, "compare_aro_results.py")
